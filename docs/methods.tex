...
current registry, RTX 40 attribution itself is unaffected. Both capacity tables
use v0.2.0 specifications; specification additions do not change matching and so
require re-running only stages 3.5 and later, never the scan or the LLM.
