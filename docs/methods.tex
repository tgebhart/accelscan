...
permalinks rather than to pages that mutate; the generators additionally record
the SHA-256 of every input they parsed, which makes a re-fetch verifiable without
redistributing the vendor table. Because matching is decided by the hand file
