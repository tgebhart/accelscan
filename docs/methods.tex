...
Registry v0.3.0 contains $1{,}153$ entries: $1{,}131$ specific models, 13
...
reporting is measurable). By manufacturer: NVIDIA 562, AMD 544, Apple 18,
Google 10, Intel 6, Cerebras 3, Huawei 2, Amazon 2, Graphcore 1. By market
segment: consumer 922, workstation 130, datacenter 62, cloud 11, embedded 6.
...
Release dates span 2000--2026 and are populated for all $1{,}131$ models, since
the frontier-lag and half-life estimands depend on them. Per-device
specification coverage across models is: memory $97.9\%$, FP32 $64.3\%$, FP64
$46.0\%$, dense FP16 tensor throughput $5.7\%$ (defined only for post-Volta
parts), TDP $68.1\%$. Missing specifications remain null and are excluded
