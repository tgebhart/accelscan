...
page, the Tensor Processing Unit page, and the ``Comparison of M-series
processors'' table of the Apple silicon page, collapsing per-variant rows (memory
size, form factor, GPU-core bin, edition) into canonical models and merging duplicate entries
...
Registry v0.3.0 contains $1{,}208$ entries: $1{,}186$ specific models, 13
...
reporting is measurable), spanning 24 manufacturers. The largest are NVIDIA 568,
AMD 546, Apple 18, Google 11, and then a long tail of eight or fewer entries each
(Huawei, Cambricon, Intel, Baidu, Amazon, Meta, Cerebras, Microsoft, MetaX,
Iluvatar, Biren, Graphcore, \ldots). By market segment: consumer 922,
workstation 130, datacenter 112, cloud 22. Embedded inference modules (the
NVIDIA Jetson line) are out of scope and carry no registry entry, so a Jetson
mention resolves only as an NVIDIA brand mention and never enters a model-level
series.
...
Release dates span 2000--2026 and are populated for all $1{,}186$ models, since
the frontier-lag and half-life estimands depend on them. Per-device
specification coverage across models is: memory $97.6\%$, FP32 $64.9\%$, FP64
$45.3\%$, dense FP16 tensor throughput $7.8\%$ (defined only for post-Volta
parts), TDP $69.8\%$. Missing specifications remain null and are excluded
