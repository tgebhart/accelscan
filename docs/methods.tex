...
% (registry v0.3.1; extraction 2026-07/08). Regenerate with the notebooks in
...
Registry v0.3.1 contains $1{,}226$ entries: $1{,}217$ specific models and 9
...
now holds only the gate vocabularies, the generic terms and the NVIDIA
architecture words, none of which any hardware table supplies.
